...
const timisoaraTestimonials = [
  // Replace these with actual testimonials and corresponding images
  {
    ...
    testimonial:
      "Timisoara's rich history and vibrant streets captivated me from the moment I arrived. A city full of life and culture!",
  },
    {
    ...
    testimonial:
      'The stunning architecture and friendly locals made my photography trip exceptional. Timisoara is a hidden treasure waiting to be captured!',
  },
  {
    ...
    testimonial:
      'The culinary scene in Timisoara offers a delightful journey through taste, with each dish reflecting the city’s diverse influences.',
  },
  {
    ...
    occupation: 'Musician',
    testimonial:
      'From classical concerts to vibrant nightlife, the music in Timisoara moves not just the body, but the soul.',
  },
  {
    ...
    testimonial:
      'The innovative spirit of Timisoara, with its blend of history and modernity, creates a perfect backdrop for business and pleasure.',
  },
  {
    ...
    testimonial:
      'Timisoara’s rich past is palpable in its landmarks. Each cobblestone tells a story of eras bygone yet dearly preserved.',
  }
    ...
    >
      ...
      >
        ...
        <Typography variant="body1" color="text.secondary">
          Experience Timisoara's charm through glowing testimonials! Visitors love our vibrant culture, 
